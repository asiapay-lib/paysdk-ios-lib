...
typedef SWIFT_ENUM(NSInteger, ApplePayButtonStyle, closed) {
  ApplePayButtonStyleWhite = 0,
  ApplePayButtonStyleWhiteOutline = 1,
  ApplePayButtonStyleBlack = 2,
};

typedef SWIFT_ENUM(NSInteger, ApplePayButtonType, closed) {
...
typedef SWIFT_ENUM(NSInteger, EnvType, closed) {
  EnvTypeSANDBOX = 0,
  EnvTypePRODUCTION = 1,
};
...
typedef SWIFT_ENUM(NSInteger, PayChannel, closed) {
  PayChannelWEBVIEW = 0,
  PayChannelDIRECT = 1,
...
typedef SWIFT_ENUM(NSInteger, PayGate, closed) {
  PayGatePAYDOLLAR = 0,
  PayGatePESOPAY = 1,
  PayGateSIAMPAY = 2,
};
...
typedef SWIFT_ENUM(NSInteger, PaySDKButtonType, closed) {
...
typedef SWIFT_ENUM(NSInteger, payMethod, closed) {
  payMethodALL = 0,
...
typedef SWIFT_ENUM(NSInteger, payType, closed) {
