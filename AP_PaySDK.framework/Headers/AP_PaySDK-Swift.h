...
SWIFT_CLASS("_TtC9AP_PaySDK15IQBarButtonItem")
...
SWIFT_CLASS("_TtC9AP_PaySDK28IQBarButtonItemConfiguration")
...
SWIFT_CLASS("_TtC9AP_PaySDK12IQInvocation")
...
SWIFT_CLASS("_TtC9AP_PaySDK17IQKeyboardManager")
...
@interface IQKeyboardManager (SWIFT_EXTENSION(AP_PaySDK)) <UIGestureRecognizerDelegate>
...
@interface IQKeyboardManager (SWIFT_EXTENSION(AP_PaySDK))
...
SWIFT_CLASS("_TtC9AP_PaySDK26IQKeyboardReturnKeyHandler")
...
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(AP_PaySDK)) <UITextFieldDelegate>
...
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(AP_PaySDK)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC9AP_PaySDK18IQPreviousNextView")
...
SWIFT_CLASS("_TtC9AP_PaySDK10IQTextView")
...
SWIFT_CLASS("_TtC9AP_PaySDK20IQTitleBarButtonItem")
...
SWIFT_CLASS("_TtC9AP_PaySDK9IQToolbar")
...
@interface UIImage (SWIFT_EXTENSION(AP_PaySDK))
...
@interface UIScrollView (SWIFT_EXTENSION(AP_PaySDK))
...
@interface UIView (SWIFT_EXTENSION(AP_PaySDK))
...
@interface UIViewController (SWIFT_EXTENSION(AP_PaySDK))
