...
typedef SWIFT_ENUM(NSInteger, PayMethodType, open) {
  PayMethodTypeVisa = 0,
  PayMethodTypeAll = 1,
  PayMethodTypeOctopus = 2,
  PayMethodTypeFps = 3,
  PayMethodTypeUnionpay = 4,
  PayMethodTypeCredit = 5,
  PayMethodTypeAlipayhk = 6,
  PayMethodTypeAlipaycn = 7,
  PayMethodTypeAlipayapp = 8,
  PayMethodTypeAlipayhkonline = 9,
  PayMethodTypeWechatonline = 10,
  PayMethodTypeWechatapp = 11,
  PayMethodTypePayme = 12,
  PayMethodTypeThreeDS2 = 13,
  PayMethodTypeApplepay = 14,
  PayMethodTypeBocpay = 15,
};
